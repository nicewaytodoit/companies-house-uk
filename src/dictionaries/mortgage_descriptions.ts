...
export const ClassificationDesc: IDictionary = {
  'charge-description': 'Charge description',
  'nature-of-charge': 'Nature of the charge',
};

export const Status: IDictionary = {
...
export const AssetsCeasedReleased: IDictionary = {
...
export const ParticularDescription: IDictionary = {
...
export const ParticularFlags: IDictionary = {
